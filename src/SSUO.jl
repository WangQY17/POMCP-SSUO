...
"""
@with_kw mutable struct SSUOSolver{RNG<:AbstractRNG} <: AbstractPOMCPSolver
    eps::Float64                = 0.01
    ...
    node_sr_belief_updater      = SSUONodeFilter()
...
function solve(solver::SSUOSolver, problem::POMDP)
    return SSUOPlanner(solver, problem)
end
